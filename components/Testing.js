  ...
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 bg-black">
      <div className="flex flex-col items-center justify-between w-full mb-10 lg:flex-row">
        ...
        <div className="flex items-center justify-center lg:w-1/2 text-black">
          <div className="w-2/5">
            {/* <img
            ...
            /> */}
            <p
              //   className="text-black -translate-y-[50%] rotate-90"
              className={`heroRightText md:top-[40%] -translate-y-[50%] rotate-90 text-black -left-20 sm:left-10  md:-left-28  lg:-left-20 xl:-left-1 text-9xl `}
          ...
          <div className="w-5/12 -ml-0 lg:ml-10">
            ...
            /> */}
            <p
              className="heroRightText text-8xl md:text-9xl rotate-90 absolfute left-[45%] -translate-x-1/2 z-10"
              //   initial={{ x: -100, opacity: 0, rotate: 90 }}
              //   whileInView={{ x: 0, opacity: 1, rotate: 90 }}
